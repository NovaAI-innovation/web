    ...
    return (
      <main className="min-h-screen bg-chimera-black flex items-center justify-center">
        <div className="max-w-md w-full px-8 text-center">
          <div className="mx-auto w-16 h-16 bg-chimera-gold/10 rounded-2xl flex items-center justify-center mb-8">
          ...
          {devResetLink && (
            <div className="mb-8 p-4 rounded-2xl bg-chimera-gold/10 border border-chimera-gold/30 text-sm">
