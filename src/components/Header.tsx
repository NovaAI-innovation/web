...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-black/90 backdrop-blur-md border-b border-chimera-border">
      <div className="bg-chimera-surface py-2 text-sm border-b border-chimera-border/60">
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-center gap-8 md:gap-10 text-chimera-text-muted">
      ...
      <nav className="max-w-7xl mx-auto px-6">
        <div className="flex items-center justify-between h-40">
          ...
          <div className="hidden md:flex items-center gap-14">
            ...
            <Link
              href="/client-portal"
              className={`${isPortalRoute ? 'text-2xl px-6 py-4' : 'text-xl px-5 py-3'} font-medium text-chimera-text-muted border border-chimera-border rounded-md hover:text-chimera-gold hover:border-chimera-gold/40 transition-colors`}
            >
              Client Portal
            </Link>
          </div>
